    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> AddDetail(int? id)
        {
            ...
            DetailViewModel model = new DetailViewModel
            {
                ...
                Procedures = _combosHerlper.GetCombosProcedures()
            };
        ...
        public async Task<IActionResult> AddDetail(DetailViewModel detailViewModel)
        {
            if (ModelState.IsValid)
            {
                ...
                Detail detail = await _convertHelper.ToDetailAsync(detailViewModel, true);
            ...
            detailViewModel.Procedures = _combosHerlper.GetCombosProcedures();
        ...
        public async Task<IActionResult> EditDetail(int? id)
        {
            ...
            DetailViewModel model = _convertHelper.ToDetailViewModel(detail);
            return View(model);
        }
        ...
        public async Task<IActionResult> EditDetail(int id, DetailViewModel detailViewModel)
        {
            if (ModelState.IsValid)
            {
                Detail detail = await _convertHelper.ToDetailAsync(detailViewModel, false);
